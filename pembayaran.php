...
<section id="home-section" class="ftco-section">
	<div class="container mt-4">
		...
		<div class="row justify-content-center mb-5 mt-5">
			...
			<div class="col-md-7">
				<div class="alert alert-info">Total Tagihan Anda : <strong>Rp. <?php echo number_format($detpem["totalbeli"]) ?> (Sudah
						Termasuk PPN)</strong> <br> Pembayaran: <br>
					BCA : 123456789 <br>
					E-Wallet : 0812345678910	</div>
...
if (isset($_POST["kirim"])) {
	...
	$koneksi->query("INSERT INTO pemba	yaran(idpenjualan, nama, tanggaltransfer,tanggal, bukti)
